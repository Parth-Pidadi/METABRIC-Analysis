...
merged_data_clean_file <- file.path(getwd(), "METABRIC_BLVRB_merged_data_clean.csv")
merged_data_file <- file.path(getwd(), "METABRIC_BLVRB_merged_data.csv")

if (file.exists(merged_data_clean_file)) {
...
} else if (file.exists(merged_data_file)) {
...
if (length(missing_cols) > 0) {
  ...
  cat("    - WARNING: Chemotherapy analysis section was skipped\n")
}
